...
/datum/combat_music/acolyte
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/church/combat_acolyte.ogg')
...
/datum/combat_music/adjudicator
	...
	musicpath = list('modular_rmh/sound/music/combat/templarofpsydonia.ogg')
...
/datum/combat_music/adventurer_default
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/adventurer/combat_outlander2.ogg')
...
/datum/combat_music/adventurer_2
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/adventurer/combat_outlander.ogg')
...
/datum/combat_music/adventurer_3
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/adventurer/combat_outlander3.ogg')
...
/datum/combat_music/adventurer_4
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/adventurer/combat_outlander4.ogg')
...
/datum/combat_music/bandit_soldier
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/antag/combat_thewall.ogg')
...
/datum/combat_music/bandit_rogue
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/antag/combat_cutpurse.ogg')

/datum/combat_music/barbarian
	name = "Barbarian"
	desc = "Grit as if you had teeth to grit with left."
	shortname = "Barbarian"
	musicpath = list('modular_rmh/sound/music/combat/combat_gronn.ogg')
...
/datum/combat_music/berserker
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_berserker.ogg')

/datum/combat_music/blackoak
	name = "Black Oak's Guardian"
	desc = "Trees were made for hanging."
	shortname = "Black Oak"
	musicpath = list('modular_rmh/sound/music/combat/combat_blackoak.ogg')
...
/datum/combat_music/beggar
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_bum.ogg')

/datum/combat_music/conddottiero
	name = "Condottiero Guildsman"
	desc = "Rue the dae, of the smiling profiteer."
	shortname = "Condottiero"
	musicpath = list('modular_rmh/sound/music/combat/combat_condottiero.ogg')
...
/datum/combat_music/combat_old_2
	...
	musicpath = list('modular_rmh/sound/music/combat/combat2.ogg')
*/
...
/datum/combat_music/darkstar
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/antag/combat_darkstar.ogg')
...
/datum/combat_music/desertrider
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_desertrider.ogg')
...
/datum/combat_music/druid
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_druid.ogg')
...
/datum/combat_music/dungeoneer
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_dungeoneer.ogg')
...
/datum/combat_music/forlorn
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_blackstar.ogg')
...
/datum/combat_music/highgrain
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_highgrain.ogg')
...
/datum/combat_music/iconoclast
	...
	musicpath = list('modular_rmh/sound/music/combat/Iconoclast.ogg')
...
/datum/combat_music/inquisitor
	...
	musicpath = list('modular_rmh/sound/music/combat/inquisitorcombat.ogg')

/datum/combat_music/inquis_ordinator
	name = "Inquisitor - Ordinator"
	desc = ""
	shortname = "Ordinator"
	musicpath = list('modular_rmh/sound/music/combat/combat_inqordinator.ogg')
...
/datum/combat_music/jester
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_jester.ogg')

/datum/combat_music/kazengite
	name = "Kazengite"
	desc = ""
	shortname = "Kazengite"
	musicpath = list('modular_rmh/sound/music/combat/combat_kazengite.ogg')
...
/datum/combat_music/knight
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_knight.ogg')
...
/datum/combat_music/man_at_arms
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_ManAtArms.ogg')
...
/datum/combat_music/malpractice
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_malpractice.ogg')
...
/datum/combat_music/maniac
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_maniac2.ogg')
...
/datum/combat_music/maniac_old
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_maniac.ogg')
*/
...
/datum/combat_music/martyr
	...
	desc = ""
	shortname = "Martyr"
	musicpath = list('modular_rmh/sound/music/combat/combat_martyrsafe.ogg')
...
/datum/combat_music/magician
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/nobility/combat_courtmage.ogg')
...
/datum/combat_music/nitecreecher
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_nitecreecher.ogg')

/datum/combat_music/noble
	name = "Noble (Merchant/Freifechter)"
	desc = ""
	shortname = "Noble"
	musicpath = list('modular_rmh/sound/music/combat/combat_noble.ogg')
...
/datum/combat_music/ozium
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_ozium.ogg')
...
/datum/combat_music/physician
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_physician.ogg')

/datum/combat_music/poacher
	name = "Poacher Wretch"
	desc = ""
	shortname = "Poacher"
	musicpath = list('modular_rmh/sound/music/combat/combat_poacher.ogg')
...
/datum/combat_music/reckoning
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/church/combat_reckoning.ogg')

/datum/combat_music/routier
	name = "Routier, Otavan"
	desc = ""
	shortname = "Rogue"
	musicpath = list('modular_rmh/sound/music/combat/combat_routier.ogg')
...
/datum/combat_music/shaman
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_shaman2.ogg')
...
/datum/combat_music/spymaster
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/nobility/combat_spymaster.ogg')
...
/datum/combat_music/squire
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_squire.ogg')
...
/datum/combat_music/starsugar
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_starsugar.ogg')
...
/datum/combat_music/steppe
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_steppe.ogg')
...
/datum/combat_music/league
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_league.ogg')
...
/datum/combat_music/town_dirt
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/towner/combat_towner.ogg')
...
/datum/combat_music/town_heavyweights
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/towner/combat_towner2.ogg')
...
/datum/combat_music/town_skilled
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/towner/combat_towner3.ogg')
...
/datum/combat_music/town_leaders
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/towner/combat_retired.ogg')
...
/datum/combat_music/varangian
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_vagarian.ogg')
...
/datum/combat_music/vampire
	...
	musicpath = list('modular_rmh/sound/music/combat/cmode/antag/combat_thrall.ogg')
...
/datum/combat_music/vampire_old
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_vamp.ogg')
*/
...
/datum/combat_music/vaquero
	...
	desc = ""
	shortname = "Vaquero"
	musicpath = list('modular_rmh/sound/music/combat/combat_vaquero.ogg')
...
/datum/combat_music/veteran
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_veteran.ogg')
...
/datum/combat_music/vigilante
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_vigilante.ogg')
...
/datum/combat_music/warscholar
	...
	musicpath = list('modular_rmh/sound/music/combat/warscholar.ogg')
...
/datum/combat_music/werewolf_old
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_werewolf.ogg')
*/
...
/datum/combat_music/zybantine
	...
	musicpath = list('modular_rmh/sound/music/combat/combat_zybantine.ogg')
