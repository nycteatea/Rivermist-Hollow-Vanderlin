...
/**
 * Get all organs relating to a specific slot in a specific body zone
 *
 * Arguments:
 * * slot Slot to get the organs from
 * * zone Body zone to check
 */
 ...
 *
 * This will return a list of all the organs that are relevant to the zone that is passed in.
 *
 * Arguments:
 * * zone Body zone to check
 * * subzones Include subtargets of the bodypart for this zone.
 */
 ...
 */
/mob/proc/getorganslotefficiencyzone(slot, zone)
	return
