/datum/ambush_config/wolf_pack
	mob_types = list(
		/mob/living/simple_animal/hostile/retaliate/wolf = 3
	)
...
/datum/ambush_config/mole_pack
	mob_types = list(
		/mob/living/simple_animal/hostile/retaliate/mole = 3
	)

/datum/ambush_config/deserter_patrol
	mob_types = list(
		/mob/living/carbon/human/species/human/northern/militia/deserter = 3
	)
...
/datum/ambush_config/highwayman_gang
	mob_types = list(
		/mob/living/carbon/human/species/human/northern/highwayman/ambush = 4
	)

/datum/ambush_config/mixed_wildlife
	mob_types = list(
		/mob/living/simple_animal/hostile/retaliate/wolf = 2,
		/mob/living/simple_animal/hostile/retaliate/raccoon = 2
	)
